...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Koordinasi Wilayah</h1>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('korwil.update', $korwil->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ $korwil->code }}" name="code" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Nama Wilayah</label>
                                    <input class="form-control" value="{{ $korwil->name }}" name="name" required />
                                </div>
                            </div>
                        </div>
