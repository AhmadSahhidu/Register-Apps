...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Input Kompetisi / Lomba</h1>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('competision.store') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" value="1" class="form-control"
                                        name="count_session" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Jumlah Gantangan</label>
                                    <input type="number" readonly value="300" min="0" class="form-control"
                                        name="count_gantangan" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Jumlah Korwil Yang Ikut</label>
                                    <input type="number" min="0" class="form-control" name="count_korwil"
                                        required />
                                </div>
                            </div>
                        </div>
